...
move:move(*,0.9,1)`,
    ...
    {
        name: "Starting Manipulator Patterns: Concepts and Nicki's 3-Count Roundabout",
...
M: SB z SB z  IB . CB↺ z`,
    ...
    {
        name: "Starting Manipulator Patterns: Concepts and Nicki's 3-Count Roundabout - The First Manipulator Pattern: Nicki's 3-Count Roundabout",
...
N: SAe z SAl z IAvo . CA↺ z`,
    ...
    {
        name: "Roundabout Variations - 4 and 5 Person Patterns based on Roundabout (2)",
...
move: Cmove(C,4.9,2.5,144,1)`,
    ...
    {
        name: "Roundabout Variations - 4 and 5 Person Patterns based on Roundabout (3)",
...
move: Vmove(B,4.9,3)`,
    ...
    {
        name: "Scrambled V and other Scrambled Patterns - Combining Scrambles (5+ Persons)",
        pattern: `A: 3pB3  3pC3  3pB3  -- B
B: 3pA3  3  3  3pA3  -- C
C: 3 3   3pA3  3  3  -- A
M: CBz   SBz   IC.   -- M
