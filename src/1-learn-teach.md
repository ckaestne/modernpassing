...
On the other hand, most other passers will have learned *6-club four-count* first and other [synchronous patterns](2b-basic-sync.md) next. To have a wider range of passing partners at all levels, it is useful to learn those patterns too. They are also the foundation for most [group patterns](5a-intro.md). Depending on how stable their cascade is, some beginners might find it easier to learn patterns with more selfs, like *six-count*, while others might prefer starting with patterns with fewer selfs, such as *pass-pass-self*.
