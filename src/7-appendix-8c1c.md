...
* Singles vs doubles -- Four-handed siteswap *79*, see [compatible siteswaps](4h-4hsw-compatible.md)
  * both straight or both crossing (i.e., swapping A and B positions)
* Zaps vs triples -- Four handed siteswap *5b*
* Crossing doubles -- Synchronous pattern 4p, see [7-club and 8-club patterns](2d-advanced.md)
...
* Crossing singles -- Synchronous pattern 4p, thrown with singles, see [beyond classic patterns](2e-beyond.md)
* Straight singles -- Synchronous pattern 4p, thrown with singles, see [beyond classic patterns](2e-beyond.md)
