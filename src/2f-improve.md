...
About 110 to 120 beats per minute is a typical reasonable speed for synchronous 6-club patterns, 90 beats per minute is reachable when deliberately slowing down, and 130–160 beats per minute would be on the fast end. For galloped patterns, these higher speeds are common, and for [fully synchronized patterns](2e-beyond.md), 100–120 beats per minute is normal (i.e., effectively twice the speed of a normal pattern).
