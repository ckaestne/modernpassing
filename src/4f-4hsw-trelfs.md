...
**Five-count popcorn (7a666).** A well-known, popular 7-club pattern. Some might find it easier to first throw *trelf-self* as a trick instead of *heff-heff* in *78686* (see [heffs]()). Note that the trelf is always the same club.
