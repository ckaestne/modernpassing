...
Four-handed siteswaps come at all difficulty levels and can be learned as the first patterns, before [synchronous patterns](2a-intro-notation.md). We strongly recommend to first learn here how to read the notation and then try the [beginner patterns](4b-4hsw-beginner.md). After that [doubles](4c-4hsw-doubles.md), [heffs](4d-4hsw-heffs.md), [zaps](4e-4hsw-zaps.md), and [trelfs](4f-4hsw-trelfs.md) can be added in any order. 
