...
All 3-person *Roundabout*-style patterns on based patterns with an *odd period* are symmetric in that they have a left side and a right side; every passer goes through all passing and manipulator positions both left-handed and right-handed before the pattern repeats after six iterations.
