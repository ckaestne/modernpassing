...
*567-about* has easy visual cues that make it much easier than many siteswap takeouts to remember where to go and where to throw things: (1) The carry always goes to the same hand as the previous zap, whether straight or crossing. (2) The intercept is always on the opposite side, so the manipulator always walks around B's back to the other side. (3) Rather than remembering crossing vs straight zaps and passes, throw the first zap after the intercept always to the opposite hand of where the manipulator just walked, then stack the single pass on the same side.
