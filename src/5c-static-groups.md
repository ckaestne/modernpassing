...
Again, it is easy to be creative and create many more patterns by deciding who passes to whom on each beat (pairs, triangles, and a full circular exchange are all possible), usually avoiding having everybody pass through the middle at the same time.
