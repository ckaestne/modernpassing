...
test("fully synchronous patterns", async (t) => {
    const patterns: [any, string][] = [
        [{ separateleftRightRows: true, showLeftRight: false, showStraightCross: false }, "(4p 4x)(4x 2)(4x 4p)(2 4x),(4x 2)(4x 4px)(2 4x)(4px 4x)"],
        [{ separateleftRightRows: true, showLeftRight: false, showStraightCross: false, showLines: true, iterations: 8 }, "(4px 4x),(4px 4x)"],
        [{ separateleftRightRows: true, showLeftRight: false, showStraightCross: false, showLines: true, iterations: 4 }, "(4px 4x)(4x 4px),(4px 4x)(4x 4px)"],
        [{ separateleftRightRows: true, showLeftRight: false, showStraightCross: false, showLines: true, iterations: 4 }, "(4px 4x)(4px 4x),(4px 4x)(4 4p)"],
        [{ separateleftRightRows: true, showLeftRight: false, showStraightCross: false, showLines: true, iterations: 8 }, "(6px 4x)"],
        ...
        //     '(5p 3p),3p5p'],
        [{ separateleftRightRows: true, showLeftRight: false, showLines: true, iterations: 4, lineKind: "ladder", yDist: 80, yHandDist: 60, xDist: 80 }, "(4px 6)(2 2)(6 4px)(2 2),(2 2)(4p 6)(2 2)(6 4p)"],
