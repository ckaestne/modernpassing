...
export type PatternShapeFactory = {
    ...
    createLayout(roles: Role[], parsedLayoutInstructions: TLayout, parsedMovementInstructions: TMovement): [PositionSpec[], MovementSegmentSpec[], MovementSequenceSpec[], BackgroundLayout[]]
}
...
factories.push({
    ...
    createLayout: function (patternRoles: Role[], layout: TLayout, movement: TMovement): [PositionSpec[], MovementSegmentSpec[], MovementSequenceSpec[], BackgroundLayout[]] {
        ...
        const segments: MovementSegmentSpec[] = PatternPaths.brunos.movementSegments.map((s) => {
            return { fromX: s.fromX, fromY: s.fromY, path: s.path.slice(3, 8), toX: s.toX, toY: s.toY }
        })
...
factories.push({
    ...
    createLayout: function (patternRoles: Role[], layout: TLayout, movement: TMovement): [PositionSpec[], MovementSegmentSpec[], MovementSequenceSpec[], BackgroundLayout[]] {
        ...
        const segments: MovementSegmentSpec[] = PatternPaths.y.movementSegments.map((s) => {
            return { fromX: s.fromX, fromY: s.fromY, path: s.path.slice(3, 9), toX: s.toX, toY: s.toY }
        })
